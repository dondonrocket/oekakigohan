                ...
                'messages' => [
                    [
                        ...
                        'content' => [
                            ...
                            5.料理が特定できない場合は、『特定できません』と答えず、画像内の色を基に料理名を挙げてください。例えば、赤ならトマトパスタやミネストローネ、黄色ならオムライスやカレーのように、色に関連する料理名を必ず返してください。
                            6.どの料理か特定できない場合でも、『特定できません。』とは言わず、画像の色に基づいた料理名を必ず提示してください。
                            出力形式
                            料理名のみ。"],
