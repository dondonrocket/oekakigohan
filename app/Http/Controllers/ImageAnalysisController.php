            ...
            $result = OpenAI::chat()->create([
                ...
                'messages' => [
                    [
                        'role' => 'user',
                        'content' => [
                            ["type" => "text", "text" => "この画像は子どもが描いた料理です。以下の条件に従って、描かれている料理を必ず1つ挙げてください：1.画像の色や形を参考にして、できるだけ具体的な料理名を挙げてください。2.例えば、「明太子スパゲッティ」「醤油ラーメン」のように、色や形で味付けや特徴が想像できる料理名を挙げてください。3.もし料理名が特定できない場合、色や形状から最も近いと思われる料理名を1つ挙げてください。回答は必ず具体的な料理名でお願いします。"],
