                    ...
                    [
                        ...
                        'content' => [
                            ["type" => "text", "text" =>
                                ...
                                - **料理名が特定できない場合は、色で判断して以下の料理から、ランダムに出力すること。**
                                - 例:
                                    - 赤系統 → トマトパスタ、ミネストローネ、チキンのトマト煮、ナポリタン、アラビアータ
                                    - 黄色系統 → オムライス、カレー、スクランブルエッグ
                                    - 緑系統 → サラダ、ジェノベーゼパスタ、ほうれん草キッシュ、ピーマンの肉詰め、ロールキャベツ、無限ピーマン、無限キャベツ
                                    - 茶色系統 → とんかつ、さばの味噌煮、油淋鶏、春巻き
                                    - 白系統 → 肉まん、杏仁豆腐
                                    - 色とりどり → 酢豚、皿うどん
