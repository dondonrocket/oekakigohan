            ...
            $result = OpenAI::chat()->create([
                ...
                'messages' => [
                    [
                        'role' => 'user',
                        'content' => [
                            ["type" => "text", "text" => "この画像に描かれている料理名を特定して１つ挙げて下さい。条件は以下の通りです。1.回答は必ず料理名でお願いします。2.色で味付け、形で特徴を判断し、具体的な料理名にすること。（例：明太子スパゲッティ、醤油ラーメン）3.もし特定できない場合は、色や形状から適当な料理名を一つ挙げて下さい。回答は必ず料理名でお願いします。"],
